...
class DiagramControls extends React.Component {
    ...
    render() {
        ...
        <div id="injector_pt"><GaugeReading title="Inj. PT" ref={this.gauge_refs.injector_pt}/></div> */}
                    ...
                    <div id="ox_fill_valve"><Valve title="Fill Valve" toggle_cmd={this.sendDriverCommand("ox_fill")} ref={this.valve_refs.ox_fill}/></div>
                    <div id="ground_vent_valve"><Valve title="Vehicle Valve 1" toggle_cmd={this.sendDriverCommand("ground_vent")} opposite={true} ref={this.valve_refs.ground_vent} text_bottom text_margin="22px"/></div>
                    <div id="nitrogen_purge_valve"><Valve title="Vehicle Valve 2" toggle_cmd={this.sendDriverCommand("engine_vent")} ref={this.valve_refs.engine_vent}/></div>
                    <div id="engine_isolation_valve"><Valve title="Purge Valve" toggle_cmd={this.sendDriverCommand("ops_pneumatic")} ref={this.valve_refs.ops_pneumatic}/></div>
                </Box>
            </div>
        )
    }
